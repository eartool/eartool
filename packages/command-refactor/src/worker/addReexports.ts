...
import { type FilePath, getProperRelativePathAsModuleSpecifierTo } from "@eartool/utils";
...
export function addReexports(
  ...
  const exportLine = `export ${allAreTypes ? "type " : ""}{${exportSpecifiers}} from "${moduleSpecifier}";`;
